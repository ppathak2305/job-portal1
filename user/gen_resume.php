        ...
        <div class="col-md-8 col-md-offset-2">
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              <form class="form-horizontal" method="post" action="gen_resumedata.php">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6">
                    <select name="experienceNo" class="form-control" id="expNo" required="">
