    ...
    <div class="row">
        <div class="col-md-3" id="sidepanel">
            ...
            <div class="list-group">
                <a href="#" class="list-group-item active"><br>Dashboard<br></a>
        ...
        <br><br>
          ...
          <li><a href="admin_dashboard.php">Company Requests</a></li>
          <li class="active"><a href="#">Candidate Requests</a></li>
        </ul>
            <br>
        <?php
                $sql ="SELECT * FROM users where activation='2'";
        ...
        <table class="table" style="font-size:18px; font-family:Poppins-Medium;">
            ...
            <?php
                ...
                <td><?php echo $row['contact']; ?></td>
                   <td><a href="reject-user.php?id=<?php echo $row['id']; ?>">Reject</a>
