  ...
  <div class="wrapper row1">
    <header id="header" class="hoc clear"> 
      ...
      <div id="logo" class="fl_left">
        <h1><a href="index_dbms1.php">Job Portal</a></h1>
      </div>
      <!-- ################################################################################################ -->
      <nav id="mainav" class="fl_right">
        <ul class="clear">
          <li class="active"><a href="index_dbms1.php">Home</a></li>
          <?php
          if(isset($_SESSION['userid'])){
          ?>
          <li><a href="pages/dashboard.php">Dashboard</li>
          ...
          <li><a class="drop" href="#">Dropdown</a>
            <ul>
              <li><a href="pages/search.php">Search Jobs</a></li>
          ...
          <li><a href="pages/login1.php">Login</a></li>
          <li><a href="pages/test2.php">Company</a></li>
          <?php } ?>
        </ul>
      </nav>
    </header>
      ...
      <ul class="slides">
        <li>
          <article>
            ...
            <footer><a class="btn" href="pages/test2.php">Get Started</a></footer>
          </article>
        </li>
        <li>
          <article>
            ...
            <footer><a class="btn" href="pages/register.php">Find Jobs</a></footer>
          </article>
        </li>
        <li>
          <article>
            ...
            <footer><a class="btn" href="pages/index_admin.php">Click Here</a></footer>
          </article>
        </li>
      </ul>
      <!-- ################################################################################################ -->
